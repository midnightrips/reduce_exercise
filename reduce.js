...
} //completed with help from solution
...
function vowelCount(str) {
    ...
    return arr.reduce(function(acc, currentLetter) {
...
function addKeyAndValue(arr, key, value) {
    return arr.reduce(function(acc, currentObj, index) {
        acc[index][key] = value;
        return acc;
    }, arr); //needed help for this one
}
...
function partition(arr, callback) {
    return arr.reduce(function(acc, currentVal) {
        ...
        return acc;
    }, [[],[]]); //needed help for figuring out how to separate the arrays using [0] and [1]
}
